  ...
  return (
    ...
    >
      <AlertBox type="info" title="Pré-requisitos">
        ...
        <ul>
          <li>
            <strong>{"SELinux"}</strong> {' — '} {"política mandatória padrão."}
          </li>
        <li>
            <strong>{"firewalld"}</strong> {' — '} {"firewall padrão."}
          </li>
        <li>
            <strong>{"Fail2Ban"}</strong> {' — '} {"baneia IPs maliciosos."}
          </li>
        <li>
            <strong>{"Updates"}</strong> {' — '} {"dnf-automatic para patches."}
          </li>
        <li>
            <strong>{"LUKS"}</strong> {' — '} {"criptografia de disco."}
          </li>
        </ul>
