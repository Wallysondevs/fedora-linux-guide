  ...
  return (
    ...
    >
      <AlertBox type="info" title="Pré-requisitos">
        ...
        <ul>
          <li>
            <strong>{"journalctl -xe"}</strong> {' — '} {"últimos erros."}
          </li>
        <li>
            <strong>{"systemctl status"}</strong> {' — '} {"estado de serviços."}
          </li>
        <li>
            <strong>{"dmesg"}</strong> {' — '} {"mensagens do kernel."}
          </li>
        <li>
            <strong>{"rescue mode"}</strong> {' — '} {"recuperação no boot."}
          </li>
        <li>
            <strong>{"SELinux"}</strong> {' — '} {"setroubleshoot ajuda a interpretar denials."}
          </li>
        </ul>
