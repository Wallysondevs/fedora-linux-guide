    ...
    return (
      ...
      >
        <AlertBox type="info" title="Pré-requisitos">
          ...
          <ul>
            <li>
              <strong>{"Anaconda"}</strong> {' — '} {"instalador do Fedora."}
            </li>
          <li>
              <strong>{"Workstation"}</strong> {' — '} {"edição desktop com GNOME."}
            </li>
          <li>
              <strong>{"Server"}</strong> {' — '} {"edição para servidores."}
            </li>
          <li>
              <strong>{"Spins"}</strong> {' — '} {"outras DEs (KDE, XFCE, etc)."}
            </li>
          <li>
              <strong>{"Silverblue"}</strong> {' — '} {"imutável baseado em rpm-ostree."}
            </li>
          </ul>
